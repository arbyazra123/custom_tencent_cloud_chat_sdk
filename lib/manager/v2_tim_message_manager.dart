...
class V2TIMMessageManager {
  ...
  Future<void> addAdvancedMsgListener({
    ...
    return ImFlutterPlatform.instance.addAdvancedMsgListener(listener: listener, listenerUuid: uuid);
  }
  ...
  Future<void> removeAdvancedMsgListener({V2TimAdvancedMsgListener? listener}) {
    var listenerUuid = "";
    if (listener != null) {
      listenerUuid = this.advancedMsgListenerList.keys.firstWhere((k) => this.advancedMsgListenerList[k] == listener, orElse: () => "");
  ...
  ///
  @Deprecated('sendImageMessage自3.6.0开始弃用，我们将创建消息与发送消息分离，请先使用createImageMessage创建消息,再调用sendMessage发送消息')
  ...
  ///
  @Deprecated('sendVideoMessage自3.6.0开始弃用，我们将创建消息与发送消息分离，请先使用createVideoMessage创建消息,再调用sendMessage发送消息')
  ...
  Future<V2TimValueCallback<V2TimMsgCreateInfoResult>> createTargetedGroupMessage({required String id, required List<String> receiverList}) async {
    return ImFlutterPlatform.instance.createTargetedGroupMessage(id: id, receiverList: receiverList);
  }
  ...
  Future<V2TimValueCallback<V2TimMsgCreateInfoResult>> createCustomMessage({
    ...
    return ImFlutterPlatform.instance.createCustomMessage(data: data, extension: extension, desc: desc);
  }
  ...
  Future<V2TimValueCallback<V2TimMessage>> sendReplyMessage(
    ...
    final hasNickName = replyMessage.nickName != null && replyMessage.nickName != "";
    final cloudCustomData = {
      "messageReply": {"messageID": replyMessage.msgID, "messageAbstract": _getAbstractMessage(replyMessage), "messageSender": hasNickName ? replyMessage.nickName : replyMessage.sender, "messageType": replyMessage.elemType, "version": 1}
    };
  ...
  Future<V2TimValueCallback<V2TimMsgCreateInfoResult>> createMergerMessage({
    ...
    return ImFlutterPlatform.instance.createMergerMessage(msgIDList: msgIDList, title: title, abstractList: abstractList, compatibleText: compatibleText);
  }
  ...
  Future<V2TimValueCallback<V2TimMsgCreateInfoResult>> createForwardMessage({required String msgID, String? webMessageInstance}) async {
    return ImFlutterPlatform.instance.createForwardMessage(msgID: msgID, webMessageInstance: webMessageInstance);
  }

  @Deprecated('sendTextMessage自3.6.0开始弃用，我们将创建消息与发送消息分离，请先使用createTextMessage创建消息,再调用sendMessage发送消息')
  ...
  ///发送自定义消息
  ///
  @Deprecated('sendCustomMessage自3.6.0开始弃用，我们将创建消息与发送消息分离，请先使用createCustomMessage创建消息,再调用sendMessage发送消息')
  ...
  @Deprecated('sendFileMessage自3.6.0开始弃用，我们将创建消息与发送消息分离，请先使用createFileMessage创建消息,再调用sendMessage发送消息')
  ...
  /// 注意： web不支持该接口
  ///
  @Deprecated('sendSoundMessage自3.6.0开始弃用，我们将创建消息与发送消息分离，请先使用createSoundMessage创建消息,再调用sendMessage发送消息')
  ...
  /// 发送地理位置消息
  @Deprecated('sendLocationMessage自3.6.0开始弃用，我们将创建消息与发送消息分离，请先使用createLocationMessage创建消息,再调用sendMessage发送消息')
  ...
  /// data	自定义数据
  ///
  @Deprecated('sendFaceMessage自3.6.0开始弃用，我们将创建消息与发送消息分离，请先使用createFaceMessage创建消息,再调用sendMessage发送消息')
  Future<V2TimValueCallback<V2TimMessage>> sendFaceMessage({
    ...
    return await ImFlutterPlatform.instance.sendFaceMessage(
        index: index, data: data, receiver: receiver, groupID: groupID, priority: priority!.index, onlineUserOnly: onlineUserOnly, isExcludedFromUnreadCount: isExcludedFromUnreadCount, offlinePushInfo: offlinePushInfo?.toJson());
  }
  ...
  ///
  @Deprecated('sendForwardMessage自3.6.0开始弃用，我们将创建消息与发送消息分离，请先使用createForwardMessage创建消息,再调用sendMessage发送消息')
  ...
  Future<V2TimValueCallback<List<V2TimReceiveMessageOptInfo>>> getC2CReceiveMessageOpt({
    ...
    return await ImFlutterPlatform.instance.getC2CReceiveMessageOpt(userIDList: userIDList);
  }
  ...
  Future<V2TimCallback> setLocalCustomData({
    ...
    return ImFlutterPlatform.instance.setLocalCustomData(msgID: msgID, localCustomData: localCustomData);
  }
  ...
  Future<V2TimCallback> setLocalCustomInt({
    ...
    return ImFlutterPlatform.instance.setLocalCustomInt(msgID: msgID, localCustomInt: localCustomInt);
  }
  ...
  Future<V2TimCallback> setCloudCustomData({
    ...
    return ImFlutterPlatform.instance.setCloudCustomData(data: data, msgID: msgID);
  }
  ...
  Future<V2TimValueCallback<List<V2TimMessage>>> getC2CHistoryMessageList({
    ...
    return ImFlutterPlatform.instance.getC2CHistoryMessageList(userID: userID, count: count, lastMsgID: lastMsgID);
  }
  ...
  Future<V2TimValueCallback<List<V2TimMessage>>> getGroupHistoryMessageList({
    ...
    return ImFlutterPlatform.instance.getGroupHistoryMessageList(groupID: groupID, count: count, lastMsgID: lastMsgID);
  }
  ...
  Future<V2TimCallback> revokeMessage({required String msgID, Object? webMessageInstatnce}) async {
    return ImFlutterPlatform.instance.revokeMessage(msgID: msgID, webMessageInstatnce: webMessageInstatnce);
  }
  ...
  Future<V2TimCallback> deleteMessageFromLocalStorage({
    ...
    return ImFlutterPlatform.instance.deleteMessageFromLocalStorage(msgID: msgID);
  }
  ...
  Future<V2TimCallback> deleteMessages({required List<String> msgIDs, List<dynamic>? webMessageInstanceList}) async {
    return ImFlutterPlatform.instance.deleteMessages(msgIDs: msgIDs, webMessageInstanceList: webMessageInstanceList);
  }
  ...
  Future<V2TimValueCallback<V2TimMessage>> insertGroupMessageToLocalStorage({
    ...
    return ImFlutterPlatform.instance.insertGroupMessageToLocalStorage(data: data, groupID: groupID, sender: sender);
  }
  ...
  Future<V2TimValueCallback<V2TimMessage>> insertC2CMessageToLocalStorage({
    ...
    return await ImFlutterPlatform.instance.insertC2CMessageToLocalStorage(data: data, userID: userID, sender: sender);
  }
  ...
  Future<V2TimCallback> clearC2CHistoryMessage({
    ...
    return await ImFlutterPlatform.instance.clearC2CHistoryMessage(userID: userID);
  }
  ...
  Future<V2TimCallback> clearGroupHistoryMessage({
    ...
    return await ImFlutterPlatform.instance.clearGroupHistoryMessage(groupID: groupID);
  }
  ...
  Future<V2TimValueCallback<V2TimMessageSearchResult>> searchLocalMessages({
    ...
    return await ImFlutterPlatform.instance.searchLocalMessages(searchParam: searchParam);
  }
  ...
  Future<V2TimValueCallback<List<V2TimMessage>>> findMessages({
    ...
    return await ImFlutterPlatform.instance.findMessages(messageIDList: messageIDList);
  }
  ...
  Future<V2TimValueCallback<V2TimMessageOnlineUrl>> getMessageOnlineUrl({
    ...
    return await ImFlutterPlatform.instance.getMessageOnlineUrl(msgID: msgID);
  }
  ...
  Future<V2TimCallback> downloadMessage({
    ...
    return await ImFlutterPlatform.instance.downloadMessage(
      msgID: msgID,
  ...
  Future<V2TimValueCallback<Map<String, String>>> translateText({
    ...
    return await ImFlutterPlatform.instance.translateText(
      texts: texts,
  ...
  Future<V2TimValueCallback<List<String>>> setAvChatRoomCanFindMessage({
    ...
    return await ImFlutterPlatform.instance.setAvChatRoomCanFindMessage(
  ...
  Future<V2TimCallback> setAllReceiveMessageOpt({
    ...
    return ImFlutterPlatform.instance.setAllReceiveMessageOpt(opt: opt, startHour: startHour, startMinute: startMinute, startSecond: startSecond, duration: duration);
  }
  ...
  Future<V2TimCallback> setAllReceiveMessageOptWithTimestamp({
    ...
    return ImFlutterPlatform.instance.setAllReceiveMessageOptWithTimestamp(opt: opt, startTimeStamp: startTimeStamp, duration: duration);
  }

  Future<V2TimValueCallback<V2TimReceiveMessageOptInfo>> getAllReceiveMessageOpt() async {
    return ImFlutterPlatform.instance.getAllReceiveMessageOpt();
  }

  Future<V2TimValueCallback<V2TimMessageSearchResult>> searchCloudMessages({
    required V2TimMessageSearchParam searchParam,
  }) async {
    return ImFlutterPlatform.instance.searchCloudMessages(searchParam: searchParam);
  }
  ...
  Future<V2TimCallback> addMessageReaction({
    ...
    return ImFlutterPlatform.instance.addMessageReaction(msgID: msgID, reactionID: reactionID);
  }
  ...
  Future<V2TimCallback> removeMessageReaction({
    ...
    return ImFlutterPlatform.instance.removeMessageReaction(msgID: msgID, reactionID: reactionID);
  }

  Future<V2TimValueCallback<V2TimMessageReactionResult>> getMessageReactions({
    required List<String> msgIDList,
    required int maxUserCountPerReaction,
  }) async {
    return ImFlutterPlatform.instance.getMessageReactions(msgIDList: msgIDList, maxUserCountPerReaction: maxUserCountPerReaction);
  }
  ...
  Future<V2TimValueCallback<V2TimMessageReactionUserResult>> getAllUserListOfMessageReaction({
    ...
    return ImFlutterPlatform.instance.getAllUserListOfMessageReaction(msgID: msgID, reactionID: reactionID, nextSeq: nextSeq, count: count);
  }
  ...
  Future<V2TimValueCallback<String>> convertVoiceToText({
    ...
    return ImFlutterPlatform.instance.convertVoiceToText(msgID: msgID, language: language);
  }
