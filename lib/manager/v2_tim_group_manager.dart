...
class V2TIMGroupManager {
  ...
  Future<V2TimValueCallback<String>> createGroup({
    ...
    GroupAddOptTypeEnum addOptDefault = addOpt == null ? GroupAddOptTypeEnum.V2TIM_GROUP_ADD_ANY : (groupType == GroupType.AVChatRoom ? GroupAddOptTypeEnum.V2TIM_GROUP_ADD_ANY : addOpt);
    GroupAddOptTypeEnum approveOptDefault = approveOpt == null ? GroupAddOptTypeEnum.V2TIM_GROUP_ADD_FORBID : (groupType == GroupType.AVChatRoom ? GroupAddOptTypeEnum.V2TIM_GROUP_ADD_FORBID : approveOpt);
  ...
  Future<V2TimCallback> initGroupAttributes({
    ...
    return ImFlutterPlatform.instance.initGroupAttributes(groupID: groupID, attributes: attributes);
  }
  ...
  Future<V2TimCallback> setGroupAttributes({
    ...
    return ImFlutterPlatform.instance.setGroupAttributes(groupID: groupID, attributes: attributes);
  }
  ...
  Future<V2TimCallback> deleteGroupAttributes({
    ...
    return ImFlutterPlatform.instance.deleteGroupAttributes(groupID: groupID, keys: keys);
  }
  ...
  Future<V2TimValueCallback<Map<String, String>>> getGroupAttributes({
    ...
    return ImFlutterPlatform.instance.getGroupAttributes(groupID: groupID, keys: keys);
  }
  ...
  Future<V2TimValueCallback<int>> getGroupOnlineMemberCount({
    ...
    return ImFlutterPlatform.instance.getGroupOnlineMemberCount(groupID: groupID);
  }
  ...
  Future<V2TimValueCallback<V2TimGroupMemberInfoResult>> getGroupMemberList({
    ...
    return ImFlutterPlatform.instance.getGroupMemberList(groupID: groupID, filter: filter.index, nextSeq: nextSeq, count: count, offset: offset);
  }
  ...
  Future<V2TimValueCallback<List<V2TimGroupMemberFullInfo>>> getGroupMembersInfo({
    ...
    return ImFlutterPlatform.instance.getGroupMembersInfo(groupID: groupID, memberList: memberList);
  }
  ...
  Future<V2TimValueCallback<List<V2TimGroupMemberOperationResult>>> inviteUserToGroup({
    ...
    return ImFlutterPlatform.instance.inviteUserToGroup(groupID: groupID, userList: userList);
  }
  ...
  Future<V2TimCallback> kickGroupMember({
    ...
    return ImFlutterPlatform.instance.kickGroupMember(
      groupID: groupID,
      memberList: memberList,
      duration: duration,
    );
  ...
  Future<V2TimCallback> transferGroupOwner({
    ...
    return ImFlutterPlatform.instance.transferGroupOwner(groupID: groupID, userID: userID);
  }
  ...
  Future<V2TimCallback> refuseGroupApplication({
    ...
    return ImFlutterPlatform.instance.refuseGroupApplication(groupID: groupID, fromUser: fromUser, toUser: toUser, addTime: addTime, type: type.index, webMessageInstance: webMessageInstance);
  }
  ...
  Future<V2TimValueCallback<List<V2TimTopicOperationResult>>> deleteTopicFromCommunity({
    ...
    return ImFlutterPlatform.instance.deleteTopicFromCommunity(groupID: groupID, topicIDList: topicIDList);
  }
  ...
  Future<V2TimValueCallback<List<V2TimTopicInfoResult>>> getTopicInfoList({
    ...
    return ImFlutterPlatform.instance.getTopicInfoList(groupID: groupID, topicIDList: topicIDList);
  }
  ...
  Future<V2TimValueCallback<Map<String, int>>> setGroupCounters({
    ...
    return ImFlutterPlatform.instance.setGroupCounters(
      groupID: groupID,
      counters: counters,
    );
  }
  ...
  Future<V2TimValueCallback<Map<String, int>>> getGroupCounters({
    ...
    return ImFlutterPlatform.instance.getGroupCounters(
      groupID: groupID,
      keys: keys,
    );
  }
  ...
  Future<V2TimValueCallback<Map<String, int>>> increaseGroupCounter({
    ...
    return ImFlutterPlatform.instance.increaseGroupCounter(
      groupID: groupID,
      key: key,
      value: value,
    );
  ...
  Future<V2TimValueCallback<Map<String, int>>> decreaseGroupCounter({
    ...
    return ImFlutterPlatform.instance.decreaseGroupCounter(
      groupID: groupID,
      key: key,
      value: value,
    );
  ...
  Future<V2TimCallback> markGroupMemberList({
    ...
    return ImFlutterPlatform.instance.markGroupMemberList(
      groupID: groupID,
