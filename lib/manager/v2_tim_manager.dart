...
class V2TIMManager {
  ...
  V2TIMManager(MethodChannel channel) {
    ...
    this.v2ConversationManager = V2TIMConversationManager(channel);
    this.v2TIMMessageManager = V2TIMMessageManager(channel);
    this.v2TIMFriendshipManager = V2TIMFriendshipManager(channel);
    this.v2TIMGroupManager = V2TIMGroupManager(channel);
    this.v2TIMOfflinePushManager = V2TIMOfflinePushManager(channel);
    this.v2timSignalingManager = V2TIMSignalingManager(channel);
  ...
  Future<V2TimCallback> login({
    ...
    V2TimCallback res = await ImFlutterPlatform.instance
  ...
  Future<void> uikitTrace({
    ...
    ImFlutterPlatform.instance.uikitTrace(trace: trace);
  }
  ...
  Future<V2TimCallback> subscribeUserInfo({
    ...
    return ImFlutterPlatform.instance.subscribeUserInfo(userIDList: userIDList);
  }
