...
class GroupListener: NSObject, V2TIMGroupListener {
    ...
    public func onGroupCounterChanged(_ groupID: String!, key: String!, newValue: Int) {
        TencentImSDKPlugin.invokeListener(type: ListenerType.onGroupCounterChanged, method: "groupListener", data: [
            "groupID": groupID ?? "",
            "key": key ?? "",
            "value": newValue,
        ], listenerUuid: listenerUuid)
    ...
    func onAllGroupMembersMuted(_ groupID: String!, isMute: Bool) {
        TencentImSDKPlugin.invokeListener(type: ListenerType.onAllGroupMembersMuted, method: "groupListener", data: [
            "groupID": groupID ?? "",
            "isMute": isMute,
        ], listenerUuid: listenerUuid)
    }
    func onMemberMarkChanged(_ groupID: String!, memberIDList: [String]!, markType: Int32, enableMark: Bool) {
        TencentImSDKPlugin.invokeListener(type: ListenerType.onMemberMarkChanged, method: "groupListener", data: [
            "groupID": groupID ?? "",
