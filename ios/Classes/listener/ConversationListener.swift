...
//		TencentImSDKPlugin.invokeListener(type: ListenerType.onNewConversation, method: "conversationListener", data: cs, listenerUuid: listenerUuid)
    ...
    public func onConversationDeleted(_ conversationIDList: [String]!) {
        TencentImSDKPlugin.invokeListener(type: ListenerType.onConversationDeleted, method: "conversationListener", data: conversationIDList, listenerUuid: listenerUuid)
    }
    public func onUnreadMessageCountChanged(by filter: V2TIMConversationListFilter!, totalUnreadCount: UInt64) {
        ...
        dd["filter"] = fil
        TencentImSDKPlugin.invokeListener(type: ListenerType.onUnreadMessageCountChangedByFilter, method: "conversationListener", data: dd, listenerUuid: listenerUuid)
    }
}
