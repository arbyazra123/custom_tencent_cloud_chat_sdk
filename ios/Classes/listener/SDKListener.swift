...
class SDKListener: NSObject, V2TIMSDKListener {
    ...
    public func onUserInfoChanged(_ userInfoList: [V2TIMUserFullInfo]!) {
        ...
        TencentImSDKPlugin.invokeListener(type: ListenerType.onUserInfoChanged, method: "initSDKListener", data: data, listenerUuid: listenerUuid)
    }
    public func onExperimentalNotify(_ key: String!, param: NSObject!) {
        TencentImSDKPlugin.invokeListener(type: ListenerType.onExperimentalNotify, method: "initSDKListener", data: [
            "key": key as Any,
            "param": param as Any,
        ], listenerUuid: listenerUuid)
    }
    public func onAllReceiveMessageOptChanged(_ receiveMessageOptInfo: V2TIMReceiveMessageOptInfo!) {
        ...
        TencentImSDKPlugin.invokeListener(type: ListenerType.onAllReceiveMessageOptChanged, method: "initSDKListener", data: data, listenerUuid: listenerUuid)
    }
}
