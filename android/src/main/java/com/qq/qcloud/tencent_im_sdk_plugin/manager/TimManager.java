...
public class TimManager {
    ...
    public  static  V2TIMSDKListener initListener  = new V2TIMSDKListener(){
        public void onConnecting() {
            for (int i = 0; i < initListenerUUID.size(); i++) {
                String listenerUuid = initListenerUUID.get(i);
        ...
        public void onAllReceiveMessageOptChanged(V2TIMReceiveMessageOptInfo receiveMessageOptInfo) {
            for (int i = 0; i < initListenerUUID.size(); i++) {
                String listenerUuid = initListenerUUID.get(i);
                makeEventData("onAllReceiveMessageOptChanged",CommonUtil.convertV2TIMReceiveMessageOptInfoToMap(receiveMessageOptInfo), listenerUuid);
            }
        }
        ...
        public void onExperimentalNotify(String key, Object param) {
            ...
            for (int i = 0; i < initListenerUUID.size(); i++) {
                String listenerUuid = initListenerUUID.get(i);
                makeEventData("onExperimentalNotify",data,listenerUuid);
            }
        ...
        public void onUserInfoChanged(List<V2TIMUserFullInfo> userInfoList) {
            ...
            for (int i = 0; i < initListenerUUID.size(); i++) {
                ...
                makeEventData("onUserInfoChanged",data, listenerUuid);
            }
        }
    };
    ...
    public void addGroupListener(MethodCall methodCall, final MethodChannel.Result result){
        ...
        V2TIMGroupListener groupListener =  new V2TIMGroupListener() {
            ...
            public void onGroupCounterChanged (String groupID, String key, long newValue) {
                ...
                makeaddGroupListenerEventData("onGroupCounterChanged",data,listenerUuid);
            }
    ...
    public void setGroupListener(MethodCall methodCall, final MethodChannel.Result result){
        ...
        V2TIMManager.getInstance().setGroupListener(new V2TIMGroupListener() {
            ...
            public void onAllGroupMembersMuted(String groupID, boolean isMute) {
                ...
                makeaddGroupListenerEventData("onAllGroupMembersMuted",data,listenerUuid);
            }
            ...
            public void onMemberMarkChanged(String groupID, List<String> memberIDList, int markType, boolean enableMark) {
                ...
                data.put("enableMark",enableMark);
                makeaddGroupListenerEventData("onMemberMarkChanged",data,listenerUuid);
            }
        });
